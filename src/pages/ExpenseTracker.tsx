          ...
          {expenses.length > 0 && (
            <div className="w-full max-w-3xl flex flex-col items-center mb-4">
              <div className="flex justify-center space-x-4 mb-4">
                <input type="text" placeholder="Date" value={dateFilter} onChange={handleFilterChange(setDateFilter)} className="border p-2 rounded" />
                <input type="text" placeholder="Category" value={categoryFilter} onChange={handleFilterChange(setCategoryFilter)} className="border p-2 rounded" />
                <input type="text" placeholder="Amount" value={amountFilter} onChange={handleFilterChange(setAmountFilter)} className="border p-2 rounded" />
                <input type="text" placeholder="Description" value={descriptionFilter} onChange={handleFilterChange(setDescriptionFilter)} className="border p-2 rounded" />
              </div>

              <ExpenseList expenses={filteredExpenses} budget={budget} />
            </div>
          )}
        </>
      )}
